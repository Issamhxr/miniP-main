import "./chunk-ZM5ELZHX.js";
import {
  hexID
} from "./chunk-UFCP2H3G.js";
import {
  fade,
  slide
...
import {
  ...
  wrap_snippet,
  writable
} from "./chunk-RNENGTBC.js";
import "./chunk-U7P2NEEE.js";
import {
  append,
  comment,
  from_html
} from "./chunk-VR2YYPII.js";
import {
  FILENAME,
  HMR,
  child,
...
Base[FILENAME] = "C:/Users/shifttech/Downloads/miniP-main/miniP-main/node_modules/@tadashi/svelte-notification/dist/components/Base.svelte";
var root = add_locations(from_html(`<div role="alert" aria-atomic="true"><div class="_tadashi_svelte_notification__content s-9EpSBY7-dSXR"><!></div> <button aria-label="Remove notification" class="_tadashi_svelte_notification__btn s-9EpSBY7-dSXR"></button></div>`), Base[FILENAME], [[19, 0, [[32, 1], [35, 1]]]]);
var $$css = {
  hash: "s-9EpSBY7-dSXR",
  code: "\n	._tadashi_svelte_notification.s-9EpSBY7-dSXR {\n		position: relative;\n		display: grid;\n		grid-template-columns: 1fr 40px;\n		grid-gap: 1px;\n		margin: var(--tadashi_svelte_notification_margin, 0 0 0.9em);\n		border-radius: var(--tadashi_svelte_notification_border_radius, 3px);\n		box-shadow: var(--tadashi_svelte_notification_box_shadow, 0 4px 10px hsl(0deg 0% 0% / 10%));\n		overflow: hidden;\n	}\n\n	._tadashi_svelte_notification__content.s-9EpSBY7-dSXR {\n		padding: var(--tadashi_svelte_notification__content_padding, 0.9em);\n		box-sizing: border-box;\n		word-wrap: break-word;\n	}\n\n	._tadashi_svelte_notification__btn.s-9EpSBY7-dSXR {\n		padding: 0;\n		margin: 0;\n		border: none;\n		border-radius: 0;\n		outline: none;\n		background: none;\n		cursor: pointer;\n		box-sizing: border-box;\n		font-size: var(--tadashi_svelte_notification__btn_font_size, 1.5em);\n		font-family: var(--tadashi_svelte_notification__btn_font_family, monospace);\n	}\n\n	._tadashi_svelte_notification__btn.s-9EpSBY7-dSXR:after {\n		content: var(--tadashi_svelte_notification__btn__after_content, '✗');\n	}\n\n	._tadashi_svelte_notification.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__content:where(.s-9EpSBY7-dSXR),\n	._tadashi_svelte_notification.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__btn:where(.s-9EpSBY7-dSXR) {\n		background: var(--tadashi_svelte_notification_background, hsl(0deg 100% 100% / 90%));\n		color: var(--tadashi_svelte_notification_color, hsl(0deg 0% 0%));\n	}\n\n	._tadashi_svelte_notification__success.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__content:where(.s-9EpSBY7-dSXR),\n	._tadashi_svelte_notification__success.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__btn:where(.s-9EpSBY7-dSXR) {\n		background: var(--tadashi_svelte_notification__success_background, hsl(149deg 96% 42% / 90%));\n		color: var(--tadashi_svelte_notification__success_color, hsl(0deg 100% 100%));\n	}\n\n	._tadashi_svelte_notification__warning.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__content:where(.s-9EpSBY7-dSXR),\n	._tadashi_svelte_notification__warning.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__btn:where(.s-9EpSBY7-dSXR) {\n		background: var(--tadashi_svelte_notification__warning_background, hsl(44deg 100% 50% / 90%));\n		color: var(--tadashi_svelte_notification__warning_color, hsl(0deg 0% 0%));\n	}\n\n	._tadashi_svelte_notification__danger.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__content:where(.s-9EpSBY7-dSXR),\n	._tadashi_svelte_notification__danger.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__btn:where(.s-9EpSBY7-dSXR) {\n		background: var(--tadashi_svelte_notification__danger_background, hsl(359deg 88% 64% / 90%));\n		color: var(--tadashi_svelte_notification__danger_color, hsl(0deg 100% 100%));\n	}\n\n	._tadashi_svelte_notification__info.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__content:where(.s-9EpSBY7-dSXR),\n	._tadashi_svelte_notification__info.s-9EpSBY7-dSXR > ._tadashi_svelte_notification__btn:where(.s-9EpSBY7-dSXR) {\n		background: var(--tadashi_svelte_notification__info_background, hsl(213deg 56% 47% / 90%));\n		color: var(--tadashi_svelte_notification__info_color, hsl(0deg 100% 100%));\n	}\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiQmFzZS5zdmVsdGUiLCJtYXBwaW5ncyI6IiIsIm5hbWVzIjpbXSwiaWdub3JlTGlzdCI6W10sInNvdXJjZXMiOlsiQmFzZS5zdmVsdGUiXX0= */"
};
function Base($$anchor, $$props) {
  ...
  template_effect(
    ($0) => {
      ...
      classes = set_class(div, 1, "_tadashi_svelte_notification s-9EpSBY7-dSXR", null, classes, $0);
...
Notification[FILENAME] = "C:/Users/shifttech/Downloads/miniP-main/miniP-main/node_modules/@tadashi/svelte-notification/dist/components/Notification.svelte";
